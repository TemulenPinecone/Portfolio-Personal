function Hero() {
  return (
    <div className="container bg-white text-gray-600 flex">
      <div>
        {/* CONTENT */}
        <div className="content">
          <h1 className="text-3xl text-black font-bold">Hi, I'm Temulen.G</h1>
          <p>
      ...
      <div>
        <div>
          <div>
            <img className=""
              src="https://staffyourtribe.com/wp-content/uploads/2021/08/IMG_1963.png"
              alt=""
            />
          </div>
          <div className=""></div>
